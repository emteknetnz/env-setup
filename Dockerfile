...
MAINTAINER Steve Boyd <emteknetnz@gmail.com>
...
# Default www-data user/group id is 33, change it to 1000 to match the user on host
ARG USER_ID=1000
ARG GROUP_ID=1000
...
# docker_script - anything else that's just easier to write in raw bash than dockerfile
